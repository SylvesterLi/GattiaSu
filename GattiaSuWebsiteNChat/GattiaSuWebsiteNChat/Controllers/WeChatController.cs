...
namespace GattiaSuWebsiteNChat.Controllers
{
    public class WeChatController : Controller
    {
        ...
        public static readonly string Token = "GattiaSu";//与微信公众账号后台的Token设置保持一致，区分大小写。
        public static readonly string EncodingAESKey = "0RS4qZN1Wcshydmx2BvJAJkFujiVISSLNwij3mH2yLw";//与微信公众账号后台的EncodingAESKey设置保持一致，区分大小写。
        public static readonly string AppId = "wxda36e527dfe69b14";//与微信公众账号后台的AppId设置保持一致，区分大小写。
